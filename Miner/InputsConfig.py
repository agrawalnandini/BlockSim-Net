...
class InputsConfig(object):
    ...
    hashPower =  random.uniform(0,30)
    NODE = -1
    NODES = []
    # NODES += NODE
    NODES_INFO = [] #IP and Port info of all other nodes

    total_hashpower = 0
    # My IP and Port details
    # myIP = '172.31.45.186' #gethostbyname(socket. gethostname())
    myPort = 8006
    
    # the IP and Port details of the central server
    cs_ip = '3.133.151.201'
    cs_port = 8002
    ...
    startSimTime = -1
    endSimTime = -1
    simTime= 60 # the simulation length (in seconds)
